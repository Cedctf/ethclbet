  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary className="btn btn-secondary btn-sm pl-4 pr-6 py-5 shadow-md dropdown-toggle gap-0 h-10" style={{ backgroundColor: '#746097', borderColor: '#746097' }}>
        ...
        <ul className="dropdown-content menu z-2 p-2 mt-2 shadow-lg bg-base-200 rounded-box gap-1">
